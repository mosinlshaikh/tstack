...
Testing for APL should prove correctness, integration behavior, and release readiness.
...
A APL codebase should not be considered stable without repeatable automated tests.
