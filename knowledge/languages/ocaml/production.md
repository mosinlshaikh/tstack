...
Production use of OCaml requires reproducible builds, clear runtime ownership, and observable operations.
...
TStack treats OCaml production readiness as evidence-based: claims require tests, docs, and operational proof.
