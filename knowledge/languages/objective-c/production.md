# Objective-C Production

Production readiness for Objective-C requires clear build, release, runtime, and rollback contracts.
...
A Objective-C project should not be marked production-ready until tests, security checks, documentation, and release verification all pass.
