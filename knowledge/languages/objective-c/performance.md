...
Performance work in Objective-C should be evidence-driven. Measure before optimizing and keep the optimization tied to user-visible or operational goals.
