...
Testing for VBScript should prove correctness, integration behavior, and release readiness.
...
A VBScript codebase should not be considered stable without repeatable automated tests.
