...
Idris is a dependently typed functional language used for correctness-focused programming and research. This TStack pack gives maintainers practical engineering guidance for using it responsibly in real projects.

## Engineering fit

- Choose Idris when its runtime, ecosystem, and team knowledge match the problem.
