...
Testing for Idris should prove correctness, integration behavior, and release readiness.
...
A Idris codebase should not be considered stable without repeatable automated tests.
