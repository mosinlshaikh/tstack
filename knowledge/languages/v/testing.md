...
Testing for V should prove correctness, integration behavior, and release readiness.
...
A V codebase should not be considered stable without repeatable automated tests.
