...
Testing for Smalltalk should prove correctness, integration behavior, and release readiness.
...
A Smalltalk codebase should not be considered stable without repeatable automated tests.
