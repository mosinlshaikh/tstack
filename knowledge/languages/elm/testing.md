...
Testing for Elm should prove correctness, integration behavior, and release readiness.
...
A Elm codebase should not be considered stable without repeatable automated tests.
