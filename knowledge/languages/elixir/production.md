...
Production readiness for Elixir requires clear build, release, runtime, and rollback contracts.
...
A Elixir project should not be marked production-ready until tests, security checks, documentation, and release verification all pass.
