...
Testing for Crystal should prove correctness, integration behavior, and release readiness.
...
A Crystal codebase should not be considered stable without repeatable automated tests.
