...
Production use of Move requires reproducible builds, clear runtime ownership, and observable operations.
...
TStack treats Move production readiness as evidence-based: claims require tests, docs, and operational proof.
