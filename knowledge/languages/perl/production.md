...
Production readiness for Perl requires clear build, release, runtime, and rollback contracts.
...
A Perl project should not be marked production-ready until tests, security checks, documentation, and release verification all pass.
