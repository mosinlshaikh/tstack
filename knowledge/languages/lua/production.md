...
Production readiness for Lua requires clear build, release, runtime, and rollback contracts.
...
A Lua project should not be marked production-ready until tests, security checks, documentation, and release verification all pass.
