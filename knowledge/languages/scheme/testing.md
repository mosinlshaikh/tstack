...
Testing for Scheme should prove correctness, integration behavior, and release readiness.
...
A Scheme codebase should not be considered stable without repeatable automated tests.
