...
Testing for Tcl should prove correctness, integration behavior, and release readiness.
...
A Tcl codebase should not be considered stable without repeatable automated tests.
