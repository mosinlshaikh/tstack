...
Production readiness for R requires clear build, release, runtime, and rollback contracts.
...
A R project should not be marked production-ready until tests, security checks, documentation, and release verification all pass.
